...
function streaking_preprocess_html(&$vars, $hook) {
...
function streaking_preprocess_block(&$vars, $hook) {
...
function streaking_preprocess_node(&$vars) {
 ...
 */	
function streaking_id_safe($string) {
 ...
 * 
 */
function streaking_menu_link(array $variables) {
  ...
  $element['#attributes']['class'][] = streaking_id_safe($element['#title']);
